const CACHE="cardnews-studio-v15-logozoom";
const ASSETS=["./","./index.html","./app.css?v=20260922-logozoom1","./app.js?v=20260922-templatefix2","./logo-bee.png?v=1","./manifest.webmanifest"];
