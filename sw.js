const CACHE="cardnews-studio-v13-logo3";
const ASSETS=["./","./index.html","./app.css?v=20260922-logo3","./app.js?v=20260922-templatefix2","./bee-mascot-web.png?v=logo3","./manifest.webmanifest"];
