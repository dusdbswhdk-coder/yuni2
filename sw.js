const CACHE="cardnews-studio-v14-logobee";
const ASSETS=["./","./index.html","./app.css?v=20260922-logo3","./app.js?v=20260922-templatefix2","./logo-bee.png?v=1","./manifest.webmanifest"];
