const CACHE="cardnews-studio-v18-polish1";
const ASSETS=["./","./index.html","./app.css?v=20260922-set5a","./app.js?v=20260922-polish1","./logo-bee.png?v=2","./manifest.webmanifest"];
