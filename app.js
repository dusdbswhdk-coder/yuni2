(() => {
  ...
  const TEMPLATES = {
    ...
    quote:{accent:"#c6a98a",overlay:32,title:{x:110,y:390,w:860,size:72,weight:600,color:"#ffffff",align:"center",font:"Georgia, 'Noto Serif KR', serif"},body:{x:160,y:990,w:760,size:28,weight:400,color:"#ffffff",align:"center",font:"Pretendard, Arial, sans-serif"},eyebrow:{x:190,y:260,w:700,size:24,weight:700,color:"#ead7c2",align:"center",font:"Pretendard, Arial, sans-serif"}},
    magazine:{accent:"#d34b43",overlay:36,title:{x:65,y:170,w:950,size:90,weight:800,color:"#ffffff",align:"left",font:"Georgia, 'Noto Serif KR', serif"},body:{x:70,y:1050,w:860,size:29,weight:500,color:"#ffffff",align:"left",font:"Pretendard, Arial, sans-serif"},eyebrow:{x:70,y:110,w:720,size:21,weight:800,color:"#ff8d86",align:"left",font:"Pretendard, Arial, sans-serif"}}
  };
  const state = {
